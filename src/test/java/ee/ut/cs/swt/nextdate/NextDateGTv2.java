...
public class NextDateGTv2 {
	...
	public void testCreatesNextDate7() throws Throwable {
	    NextDate nextDate0 = new NextDate(12, 1987, 1987);
	    String string0 = nextDate0.run(12, 12, 1987);
	    assertEquals("12/13/1987", string0);
	}

	@Test(timeout = 4000)
	public void testCreatesNextDate6() throws Throwable {
	    NextDate nextDate0 = new NextDate(3779, 3779, 3779);
